...
// Content with correct UTF-8 characters and the new Reasons logic
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="space-y-1">
                ...
                <input 
                  ...
                  className="w-full px-4 py-2 bg-slate-100 border border-slate-200 rounded-lg text-sm outline-none focus:border-blue-400"
                  value={reason}
                ...
                <p className="text-[10px] text-slate-400 italic">Dica: Novos motivos digitados serão salvos para uso futuro.</p>
              </div>
            </div>
...
console.log('Successfully fixed encoding and added selectable reasons');
